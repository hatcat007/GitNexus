...
<task type="auto">
  <name>Task 3: Add exponential backoff calculator with Full Jitter</name>
  <files>gitnexus-mcp/src/mcp/resilience.ts</files>
  <action>
...
This is a pure function - no state management. The WebSocket server will manage attempt count.
  ...
  <done>calculateBackoff() exported, returns delay in milliseconds with Full Jitter algorithm, capped at 60s. JSDoc explains the Full Jitter choice vs ±10-20% from CONTEXT.md.</done>
</task>
